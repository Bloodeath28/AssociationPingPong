...
if ( ! function_exists( 'volleyball_club_get_default_theme_options' ) ) :
	 ...
	 */
function volleyball_club_get_default_theme_options() {

	$defaults = array();

	// Top Bar
	// $defaults['show_header_contact_info'] 		= false;
	$defaults['show_header_contact_link'] 		= false;
	...
	$defaults['featured_slider_category_readmore_text']		= esc_html__('Read More','volleyball-club');
	...
	$defaults['featured_blog_section_title']	    	= esc_html__( 'Our Blog', 'volleyball-club' );
	...
	$defaults['featured_services_section_title']	    	= esc_html__( 'Our Services', 'volleyball-club' );
	...
	$defaults['featured_posts_section_title']	    	= esc_html__( 'Blog', 'volleyball-club' );
	...
	$defaults['readmore_text']							= esc_html__('Read more','volleyball-club');
	$defaults['your_latest_posts_title']				= esc_html__('Blog','volleyball-club');

	//Footer section 		
	$defaults['copyright_text']							= esc_html__( 'Copyright &copy; All rights reserved.', 'volleyball-club' );

	// Pass through filter.
	$defaults = apply_filters( 'volleyball_club_filter_default_theme_options', $defaults );
	return $defaults;
}
...
*  Get theme options
*/
if ( ! function_exists( 'volleyball_club_get_option' ) ) :
	 ...
	 */
	function volleyball_club_get_option( $key ) {

		$default_options = volleyball_club_get_default_theme_options();
		if ( empty( $key ) ) {
			return;
		}
