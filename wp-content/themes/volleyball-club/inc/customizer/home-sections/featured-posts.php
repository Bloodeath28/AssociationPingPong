...
$wp_customize->add_section( 'section_featured_posts',
	array(
		'title'      => __( 'Latest Posts Section', 'volleyball-club' ),
		'priority'   => 100,
...
$wp_customize->add_control('theme_options[featured_posts_section_title]', 
	...
	'active_callback' => 'volleyball_club_featured_posts_active',		
	'type'        => 'text'
	)
);
...
$wp_customize->add_control(new volleyball_club_Image_Radio_Control($wp_customize, 'theme_options[featured_posts_column]', 
	array(		
	'label' 	=> __('Select Column', 'volleyball-club'),
	'section' 	=> 'section_featured_posts',
...
$wp_customize->add_control(
	new volleyball_club_Dropdown_Taxonomies_Control( $wp_customize, 'theme_options[featured_posts_category]',
		array(
		'label'    => __( 'Select Category', 'volleyball-club' ),
		'section'  => 'section_featured_posts',
