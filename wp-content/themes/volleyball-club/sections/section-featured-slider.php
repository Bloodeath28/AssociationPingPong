 ...
 */
    ...
    $data_slick_speed                        = volleyball_club_get_option( 'data_slick_speed' );
    $data_slick_infinite                     = volleyball_club_get_option( 'data_slick_infinite' );
    $data_slick_arrows                       = volleyball_club_get_option( 'data_slick_arrows' );
    $data_slick_autoplay                     = volleyball_club_get_option( 'data_slick_autoplay' );
    $data_slick_draggable                    = volleyball_club_get_option( 'data_slick_draggable' );
    $data_slick_fade                         = volleyball_club_get_option( 'data_slick_fade' );
    $featured_slider_content_type            = volleyball_club_get_option( 'featured_slider_content_type' );
    $number_of_featured_slider_items         = volleyball_club_get_option( 'number_of_featured_slider_items' );

    if( $featured_slider_content_type == 'featured_slider_page' ) :
        for( $i=1; $i<=$number_of_featured_slider_items; $i++ ) :
            $featured_slider_posts[] = volleyball_club_get_option( 'featured_slider_page_'.$i );
        endfor;  
    elseif( $featured_slider_content_type == 'featured_slider_post' ) :
        for( $i=1; $i<=$number_of_featured_slider_items; $i++ ) :
            $featured_slider_posts[] = volleyball_club_get_option( 'featured_slider_post_'.$i );
        endfor;
    endif;
    ?>
    ...
    <?php if( $featured_slider_content_type == 'featured_slider_page' ) : ?>
        <div class="section-content" data-slick='{"slidesToShow": 1, "slidesToScroll": 1, "infinite": <?php echo esc_attr( $data_slick_infinite ); ?>, "speed": <?php echo esc_attr( $data_slick_speed ); ?>, "arrows": <?php echo esc_attr( $data_slick_arrows ); ?>, "autoplay": <?php echo esc_attr( $data_slick_autoplay ); ?>, "draggable": <?php echo esc_attr( $data_slick_draggable ); ?>, "fade": <?php echo esc_attr( $data_slick_fade ); ?> }'>
            ...
            $i=-1; $j=0; 
                ...
                <article class="<?php echo esc_attr($class); ?>" style="background-image: url('<?php the_post_thumbnail_url( 'full' ); ?>');filter: saturate(.8);">

                    <div class="wrapper">
                        <div class="entry-container" style="background-image: url(<?php echo esc_url(get_template_directory_uri()."/assets/images/slider-image.png")?>);">
                            <div class="slid-content">
                                ...
                                <div class="entry-content">
                                    <?php
                                        $excerpt = volleyball_club_the_excerpt( 30 );
                                        echo wp_kses_post( wpautop( $excerpt ) );
                                    ?>
                                </div><!-- .entry-content -->
    
                                <?php $readmore_text = volleyball_club_get_option( 'readmore_text' );?>
    ...
    <?php else: ?>
        <div class="section-content" data-slick='{"slidesToShow": 1, "slidesToScroll": 1, "infinite": <?php echo esc_attr( $data_slick_infinite ); ?>, "speed": <?php echo esc_attr( $data_slick_speed ); ?>, "arrows": <?php echo esc_attr( $data_slick_arrows ); ?>, "autoplay": <?php echo esc_attr( $data_slick_autoplay ); ?>, "draggable": <?php echo esc_attr( $data_slick_draggable ); ?>, "fade": <?php echo esc_attr( $data_slick_fade ); ?> }'>
            ...
            $i=-1; $j=0; 
                ...
                $featured_slider_post_readmore_text[$j] = volleyball_club_get_option( 'featured_slider_post_readmore_text_'.$j );
